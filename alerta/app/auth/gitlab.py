...
def gitlab():
    ...
    if current_app.config['AUTH_REQUIRED'] and not ('*' in current_app.config['ALLOWED_GITLAB_GROUPS']
            or set(current_app.config['ALLOWED_GITLAB_GROUPS']).intersection(set(groups))):
